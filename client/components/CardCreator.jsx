...
// Right now, this component has props.CardList and props.addCard
const CardCreator = props => (
  <Paper style={{backgroundColor: orange500, height:500, textAlign: 'center',  width:'50%', display:'inline-block'}}>
    <p id="creatorTitle" style={{fontSize:40, paddingTop:40}}>Add New Card</p>
...
{/* <form method="POST" action="/">
  <label>Name: <input type="text" name="CardName" onChange={props.handleChange} /></label>
